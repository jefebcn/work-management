            ...
            <table className="w-full text-sm font-mono">
              <thead>
                <tr className="bg-galenic-elevated border-b border-galenic-border">
                  ...
                  <th className="px-4 py-3 text-left text-xs text-galenic-muted uppercase tracking-wider w-44">Quantità</th>
                  ...
                  <th className="px-3 py-3 text-center text-xs text-galenic-muted uppercase tracking-wider w-20">Input</th>
